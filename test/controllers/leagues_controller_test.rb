...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { league_id: @league.league_id, league_name: @league.league_name, league_password: @league.league_password }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { league_id: @league.league_id, league_name: @league.league_name, league_password: @league.league_password }
    assert_redirected_to league_path(assigns(:league))
  end
